...
MSG = (
    ...
    "  Instead:\n"
    "    hand off an issue AND wait    ~/.claude/fleet/bin/fleet-await.sh <N>   (run_in_background;\n"
    "      for its result, like a      spawns a worker if none is live, returns MERGED /\n"
    "      subagent would return it    BLOCKED / REAPED / TIMEOUT + PR + summary)\n"
