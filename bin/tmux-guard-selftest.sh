...
# merged worker's window as the last step of a cleanup reap. Build a steward window
...
# and steward (@steward=1). With the dash focused, the steward's own cleanup-reap
...
# the steward's own cleanup-reap kill-window (the reopen this issue fixes). The fix
